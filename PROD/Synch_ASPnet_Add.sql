...
--add new records
	...
	--Users
	insert into [10.192.23.10].[APT2012].[dbo].aspnet_Users (
		ApplicationId,
		--UserId,
		UserName,
		LoweredUserName,
...
/*
	--UsersScheme
	insert into [10.192.23.10].[APT2012].[dbo].aspnet_UsersScheme (
		SchemeId,
		UserId
	)
	select	u.SchemeId,
	...
	inner join [10.192.23.10].[APT2012].[dbo].aspnet_Users nu
		on i.ApplicationId = nu.ApplicationId and i.LoweredUsername = nu.LoweredUsername
*/

	--UsersInRoles
	insert into [10.192.23.10].[APT2012].[dbo].aspnet_UsersInRoles (
		UserId,
		RoleId
	)
	select	nu.UserId,
	...
	--Membership
	insert into [10.192.23.10].[APT2012].[dbo].aspnet_Membership (
		ApplicationId,
		UserId,
		Password,
		PasswordFormat,
	...
	--Profile
	insert into [10.192.23.10].[APT2012].[dbo].aspnet_Profile (
		UserId,
		FirstName,
		LastName,
		MemberId,
