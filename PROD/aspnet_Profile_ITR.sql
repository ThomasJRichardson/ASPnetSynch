...
/****** Object:  Trigger [aspnet_Profile_ITR]    Script Date: 11/13/2013 09:24:52 ******/
IF  EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[dbo].[aspnet_Profile_ITR]'))
DROP TRIGGER [dbo].[aspnet_Profile_ITR]
GO

USE [APT2012]
GO

/****** Object:  Trigger [dbo].[aspnet_Profile_ITR]    Script Date: 11/13/2013 09:24:52 ******/
SET ANSI_NULLS ON
GO
...
create trigger [dbo].[aspnet_Profile_ITR]
...
BEGIN CATCH
	SELECT	@ErrorMessage = 'Error in aspnet_Profile_ITR: ' + ERROR_MESSAGE(),
